...
variable "owner_id" {
  type        = string
  description = "(Optional) Object ID of owner to be assigned to service principal. Assigned to current user"
  default     = null
}
...
variable "assignments" {
  description = "(Required) The list of role assignments to this service principal"
  type        = list(object({
    scope                = string
